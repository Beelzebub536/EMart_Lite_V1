...
public class AddProductPanel extends JPanel {
    ...
    public AddProductPanel(MainFrame mainFrame, ProductManager productManager) {
        ...
        addButton.addActionListener(e -> {
            try {
                int id = productManager.getNextProductId();
                ...
                Product product = new Product(id, name, type, category, stock, price, warranty, description, imagePath);
                if (productManager.addProduct(product)) {
                    productManager.incrementNextProductId();
